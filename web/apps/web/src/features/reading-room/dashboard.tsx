    ...
    <section className="rounded-2xl border border-dashed border-border/80 bg-background/20 p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <p className="max-w-md text-[10px] leading-relaxed text-muted-foreground/75 font-medium">
          {t('chat.fullVersionPrefix')} · <code className="rounded bg-muted px-1.5 py-0.5 text-[9px] font-mono border border-border/30">curl -fsSL https://raw.githubusercontent.com/crystallatsyrc/QuantEvoLens/main/install.sh | bash</code> {t('chat.unlockFull')}
        </p>
      </div>
    </section>
  )
