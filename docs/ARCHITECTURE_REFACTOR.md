...
5. `funnel`: `workflows/quantevolens_funnel.py`、`workflows/funnel_*`、`core/funnel_*`、`core/layer2_strength.py`、`core/candidate_ranker.py`、ETF/market metadata adapters 和对应测试。
...
corepack pnpm --dir web --filter @quantevolens/web test
corepack pnpm --dir web --filter @quantevolens/web build
```
